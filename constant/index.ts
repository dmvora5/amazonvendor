...
export const PERMISSIONS = [
    ...
    { name: "has_cost_db_upload_download_access", label: "Cost Database Download & Upload Access" },
    { name: "has_pricing_calculation_report_access", label: "Pricing Calculation Report Access" },
];