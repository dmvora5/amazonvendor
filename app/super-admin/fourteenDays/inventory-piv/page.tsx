...
import FourteenDaysPIVTable from "@/components/fourteenDays/FourteenDaysPIVTable";
    ...
    <div className="w-full rounded-2xl">
      <div className="flex items-center py-4 justify-between">
        <Link href={PAGE_ROUTES.SUPERADMIN.CREATEUSER} className="p-2">
          <Button variant="link">fourteenDays Inventory PIV</Button>
        </Link>
      </div>
      {isSuccess ? (
        <FourteenDaysPIVTable
