...
export default {
	...
	theme: {
		extend: {
			colors: {
				backgroundBrand: {
					band: 'linear-gradient(to right, #3b82f6, #6366f1)',
				},
				brand: {
					DEFAULT: '#006838'
				},
